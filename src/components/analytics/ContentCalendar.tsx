...
export const ContentCalendar: React.FC<ContentCalendarProps> = ({ events, optimalTimes }) => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold text-slate-800">Content Calendar & Posting Optimizer</h2>
              ...
              {optimalTimes.map((time, index) => (
                <div key={index} className="space-y-2">
                  <div className="flex justify-between items-center">
                    <div>
                      <div className="font-medium text-slate-800">{time.day}</div>
                      <div className="text-sm text-slate-600">{time.hour}:00</div>
                    </div>
                    <div className="flex items-center space-x-2">
                      <div className={`w-3 h-3 rounded-full ${getOptimalTimeColor(time.performance)}`} />
                      <span className="text-sm font-semibold text-slate-800">{time.performance}%</span>
                    </div>
                  </div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 bg-green-50 rounded-lg border border-green-200">
              <div className="font-semibold text-green-800 mb-2">Best Posting Schedule</div>
            ...
            <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
              <div className="font-semibold text-blue-800 mb-2">Content Gaps</div>
