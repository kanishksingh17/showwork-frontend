...
export const ProjectLeaderboard: React.FC<ProjectLeaderboardProps> = ({ projects }) => {
  const [sortBy, setSortBy] = useState<'views' | 'engagement' | 'quality' | 'trend'>('views');
  ...
  const getRankIcon = (index: number) => {
    switch (index) {
      ...
      default: return <div className="w-5 h-5 flex items-center justify-center text-gray-600 font-bold text-sm">{index + 1}</div>;
    }
  };
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold text-gray-800">Project Performance Leaderboard</h2>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-gray-600">{project.views.toLocaleString()}</span>
                        </div>
                        <div className="flex items-center space-x-2">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-gray-600">{project.shares}</span>
                        </div>
                        <div className="flex items-center space-x-2">
                          <Star className="w-4 h-4 text-yellow-500" />
                          <span className="text-gray-600">{project.qualityScore}/100</span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div key={project.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">{project.views.toLocaleString()} views</div>
                    </div>
                  </div>
                  <div className="text-right">
          ...
          <CardContent>
            <div className="space-y-3">
              {sortedProjects
                ...
                .slice(0, 3)
                .map((project) => (
                  <div key={project.id} className="flex items-center justify-between p-3 bg-red-50 rounded-lg border border-red-200">
                    <div className="flex items-center space-x-3">
