    ...
    <section className="bg-gray-50 py-16 px-6 md:px-12 lg:px-24">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="flex-1">
          <p className="text-purple-600 text-sm font-semibold mb-2">Feature Highlights</p>
          <h2 className="text-4xl font-bold text-gray-900 mb-3">
            Elevate Your Portfolio
          </h2>
          <p className="text-gray-600 mb-10 max-w-md">
            Discover how ShowWork makes building your portfolio easier than ever.
          </p>

          <div>
            <p className="text-purple-600 text-sm font-semibold mb-2">User-Friendly</p>
              ...
              <li className="flex items-start space-x-4">
                <div className="bg-purple-100 p-2 rounded-lg">
                  <svg
                    ...
                    aria-hidden="true"
                  >
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-3-3v6m-6 3h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2z"></path>
                  </svg>
                </div>
                <div>
                  <p className="font-semibold text-gray-900">Generate tailored posts for every platform.</p>
                  <p className="text-gray-500 text-sm">Duis aute dolore ipsum nisi enim cupidatat ea duis voluptate</p>
                </div>
              </li>
              <li className="flex items-start space-x-4">
                <div className="bg-purple-100 p-2 rounded-lg">
