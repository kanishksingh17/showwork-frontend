          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <div className="text-sm text-blue-700 mb-2">
                (Likes * 2 + Shares * 5) / Views
              </div>
              <div className="text-xs text-blue-600">
                Measures content quality based on engagement depth
              </div>
            </div>
            ...
            <div className="p-4 bg-green-50 rounded-lg border border-green-200">
              ...
              <div className="text-sm text-green-700 mb-2">
                Conversions / (Time * Hourly Rate)
              </div>
              <div className="text-xs text-green-600">
                Return on investment for portfolio development
              </div>
            </div>
            ...
            <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
              ...
              <div className="text-xs text-purple-600">
                How likely content is to be shared
              </div>
            </div>
            ...
            <div className="p-4 bg-red-50 rounded-lg border border-red-200">
              ...
              <div className="text-sm text-red-700 mb-2">
                (New Followers - Lost Followers) / Total Followers
              </div>
              <div className="text-xs text-red-600">
                Net audience growth percentage
              </div>
            </div>
            ...
            <div className="p-4 bg-indigo-50 rounded-lg border border-indigo-200">
              ...
              <div className="text-sm text-indigo-700 mb-2">
                Engagement / Time Spent Creating
              </div>
              <div className="text-xs text-indigo-600">
                Efficiency of content creation process
              </div>
            </div>
          </div>
        </CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-orange-600">
                {Math.round(
                  metrics.reduce((sum, m) => sum + m.currentValue, 0) /
                    metrics.length,
                )}
              </div>
