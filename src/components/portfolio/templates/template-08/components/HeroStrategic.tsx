...
export const HeroStrategic: React.FC<{ sections?: any[] }> = ({ sections }) => {
    const section = sections?.find(s => s.variant === 'HeroStrategic' || s.id === 'about');
                        ...
                        <div className="space-y-8">
                            <div>
                                <p className="text-[11px] font-bold uppercase tracking-widest text-accent mb-4">
                                    {data.challengeLabel || "The Challenge"}
                                </p>
                                <p className="text-lg leading-relaxed text-muted font-light italic">
                                    {data.challengeText || "Complexity scales faster than manual oversight. Traditional ops are the bottleneck of modern innovation."}
                                </p>
                            </div>
                            <div>
                                <p className="text-[11px] font-bold uppercase tracking-widest text-primary mb-4">
                                    {data.shiftLabel || "The Strategic Shift"}
                                </p>
                                <p className="text-lg leading-relaxed font-medium">
                                    {data.shiftText || "We treat reliability as a product feature, engineering resilience directly into the core infrastructure."}
                                </p>
                            </div>
                        </div>
                    </div>
