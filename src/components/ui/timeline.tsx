...
export const Timeline = ({ data, containerRef: externalContainerRef }: { data: TimelineEntry[], containerRef?: React.RefObject<HTMLDivElement> }) => {
        ...
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-10 md:pt-24 md:gap-10">
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              <h3 className="md:hidden block text-xl mb-4 text-left font-semibold text-neutral-600 dark:text-neutral-400">
                {item.title}
              </h3>
              {item.content}
            </div>
