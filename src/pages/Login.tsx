...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex bg-white dark:bg-slate-900">
      {/* Left Panel - Dark Background with "Discover Your Potential" */}
      <div className="hidden lg:block relative w-1/2 bg-slate-900 text-white overflow-hidden">
        <div className="absolute inset-0 z-0">
          {/* Animated Shapes */}
          <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-blue-500 rounded-[30%] opacity-[0.04] blur-[50px] animate-pulse" style={{ animationDelay: '0s' }}></div>
          <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-indigo-500 rounded-[30%] opacity-[0.04] blur-[50px] animate-pulse" style={{ animationDelay: '-10s' }}></div>
          <div className="absolute top-10 right-10 w-64 h-64 bg-blue-400 rounded-[30%] opacity-[0.04] blur-[50px] animate-pulse" style={{ animationDelay: '-5s' }}></div>
          <div className="absolute bottom-5 left-5 w-72 h-72 bg-indigo-400 rounded-[30%] opacity-[0.04] blur-[50px] animate-pulse" style={{ animationDelay: '-15s' }}></div>
        </div>
        ...
        <div className="relative z-10 flex flex-col h-full p-12 justify-center">
          <div className="flex-grow flex flex-col justify-center pt-8">
            ...
            <div className="mt-10 space-y-4">
              <button className="w-full text-left p-4 rounded-lg bg-white/10 border border-white/20 hover:bg-white/20 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary">
                <div className="flex items-center">
                  ...
                  <div>
                    <h3 className="font-semibold">Find my next job</h3>
                    <p className="text-sm text-slate-400">Perfect for active job seekers</p>
                  </div>
              ...
              <button className="w-full text-left p-4 rounded-lg bg-white/10 border border-white/20 hover:bg-white/20 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary">
                <div className="flex items-center">
                  ...
                  <div>
                    <h3 className="font-semibold">Build my portfolio</h3>
                    <p className="text-sm text-slate-400">Showcase your skills and projects</p>
                  </div>
                  <svg className="w-5 h-5 text-slate-400 ml-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
              ...
              <button className="w-full text-left p-4 rounded-lg bg-white/10 border border-white/20 hover:bg-white/20 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary">
                <div className="flex items-center">
                  ...
                  <div>
                    <h3 className="font-semibold">Grow my network</h3>
                    <p className="text-sm text-slate-400">Connect with peers and mentors</p>
                  </div>
                  <svg className="w-5 h-5 text-slate-400 ml-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
      ...
      {/* Right Panel - Clean Light Background for Forms */}
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="grid grid-cols-2 gap-3 mb-4">
                <button
                  ...
                  className={`flex items-center justify-center py-3 px-4 border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-200 font-medium hover:scale-105 hover:shadow-lg hover:bg-slate-50 dark:hover:bg-slate-700 transition-all duration-300 ${
